...
var ContentPlugin, ContentTree, TemplatePlugin, async, defaultPlugins, loadContents, loadTemplates, logger, registerContentPlugin, registerTemplatePlugin, renderer, _ref, _ref1;

async = require('async');

logger = require('./common').logger;

_ref = require('./content'), ContentTree = _ref.ContentTree, ContentPlugin = _ref.ContentPlugin, registerContentPlugin = _ref.registerContentPlugin;

_ref1 = require('./templates'), TemplatePlugin = _ref1.TemplatePlugin, loadTemplates = _ref1.loadTemplates, registerTemplatePlugin = _ref1.registerTemplatePlugin;
